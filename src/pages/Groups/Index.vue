    ...
    <div class="detailed-version">
        <card class="detailed-card">
            ...
            <div v-if="!isFormDisabled" class="row">
                <div class="col">
                    ...
                    <vue-timepicker class="form-timepicker-group w-100" manual-input
                        v-model="data.start_time"></vue-timepicker>
                </div>
        ...
        <card v-if="this.state !== 'new'" class="links-card">
            <div class="d-flex">
                ...
                <base-button @click="linksModal = true" :disabled="isFormDisabled" type="primary" class="ml-auto" size="sm"
                    icon>
    ...
    methods: {
        submitForm() {
            ...
            if (this.state === "edit") {
                ...
                axios.post(`${process.env.VUE_APP_BASE_API_URL}/channels/`, this.data, {
                    headers: {
                        Authorization: localStorage.getItem("auth_token")
                    }
                }).then(res => {
        ...
        deleteLink(row) {
            axios.delete(`${process.env.VUE_APP_BASE_API_URL}/links/${row.id}`, {
                headers: {
                    Authorization: localStorage.getItem("auth_token")
                }
            }).then(res => {
        ...
        fetchData(DetailID) {
            axios.get(`${process.env.VUE_APP_BASE_API_URL}/channels/${DetailID}`, {
                headers: {
                    Authorization: localStorage.getItem("auth_token")
                }
            }).then(res => {
        ...
        fetchLinks(DetailID) {
            axios.get(`${process.env.VUE_APP_BASE_API_URL}/channels/links/${DetailID}`, {
                headers: {
                    Authorization: localStorage.getItem("auth_token")
                }
            }).then(res => {
